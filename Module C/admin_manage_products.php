...
<head>
    ...
    <style>
        ...
        .filter-card { background: white; padding: 20px; border-radius: 16px; box-shadow: 0 4px 20px rgba(0,0,0,0.05); margin-bottom: 25px; }
        ...
        .range-slider input { 
            position: absolute; width: 100%; height: 5px; top: 0; background: none; 
            pointer-events: none; -webkit-appearance: none; appearance: none; z-index: 2; margin: 0;
        }
        ...
        input[type="range"]::-moz-range-thumb { 
            height: 16px; width: 16px; border-radius: 50%; background: #fff; 
            border: 2px solid var(--primary-orange); pointer-events: auto; cursor: pointer; 
        }
        /* ---------------------------- */
        ...
        .thumb-item:hover { border-color: var(--primary-orange) !important; }
...
<body>
            ...
            <div class="filter-card">
                <form method="GET" id="filterForm" class="filter-row">
                    <div class="search-wrapper">
                        ...
                        <input type="text" name="search" id="searchInput" placeholder="Search name" value="<?php echo htmlspecialchars($search); ?>">
                    ...
                    <table class="table align-middle">
                        ...
                        <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-end">
                                        <a href="javascript:void(0);" class="action-link view-eye me-2 fs-5" onclick='viewProduct(<?php echo json_encode($row, JSON_HEX_APOS | JSON_HEX_QUOT); ?>)'><i class="bi bi-eye"></i></a>
                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="row g-0 border rounded text-center bg-white mt-auto">
                                <div class="col-6 border-end p-2">
                                    <div class="small text-muted italic">Gender</div>
                                    <div class="fw-bold" id="view_gender">-</div>
                                </div>
                                <div class="col-6 p-2">
                                    <div class="small text-muted italic">Age Group</div>
                                    <div class="fw-bold" id="view_age">-</div>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    function renderModalGallery(colorName) {
        ...
        images.forEach((imgSrc, idx) => {
            ...
            img.className = 'img-fluid rounded border cursor-pointer';
    ...
    clearSearch.addEventListener('click', function() {
        ...
        toggleClearIcon();      // 隐藏图标
        filterForm.submit();    // 提交表单以重置筛选结果
    });
