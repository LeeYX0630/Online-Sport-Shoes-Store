        ...
        <div class="col-md-4 mb-4">
            <div class="card p-4 text-center">
                ...
                <div class="mt-2 p-3 rounded-4" style="background-color: #FFF5EE; border: 1px solid #FFE4D3;">
                    <small class="text-muted fw-bold d-block mb-1" style="font-size: 0.7rem;">ACCOUNT BALANCE</small>
                    <h3 class="fw-800 text-orange mb-2">RM <?php echo number_format($user['User_Balance'] ?? 0, 2); ?></h3>
                    <button class="btn btn-sm btn-orange w-100">Manage Funds</button>
                </div>
            </div>
        </div>
